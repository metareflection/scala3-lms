...
trait MathOpsExp extends MathOps with EffectExp {
  ...
  override def mirror[A:Typ](e: Def[A], f: Transformer)(implicit pos: SourceContext): Exp[A] = ({
    ...
    e match {
      ...
      case Reflect(MathCeil(x), u, es) => reflectMirrored(Reflect(MathCeil(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathFloor(x), u, es) => reflectMirrored(Reflect(MathFloor(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathExp(x), u, es) => reflectMirrored(Reflect(MathExp(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathPow(x,y), u, es) => reflectMirrored(Reflect(MathPow(f(x),f(y)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathAbs(x), u, es) => reflectMirrored(Reflect(MathAbs(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathSin(x), u, es) => reflectMirrored(Reflect(MathSin(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathCos(x), u, es) => reflectMirrored(Reflect(MathCos(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathAcos(x), u, es) => reflectMirrored(Reflect(MathAcos(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathLog(x), u, es) => reflectMirrored(Reflect(MathLog(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathSqrt(x), u, es) => reflectMirrored(Reflect(MathSqrt(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathAtan2(x,y), u, es) => reflectMirrored(Reflect(MathAtan2(f(x),f(y)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      ...
      case Reflect(MathLog10(x), u, es) => reflectMirrored(Reflect(MathLog10(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathSinh(x), u, es) => reflectMirrored(Reflect(MathSinh(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathAsin(x), u, es) => reflectMirrored(Reflect(MathAsin(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathCosh(x), u, es) => reflectMirrored(Reflect(MathCosh(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathTan(x), u, es) => reflectMirrored(Reflect(MathTan(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
      case Reflect(MathTanh(x), u, es) => reflectMirrored(Reflect(MathTanh(f(x)), mapOver(f,u), f(es)))(mtyp1[A], pos)
